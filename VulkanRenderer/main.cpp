...
#pragma region Instance setup
	void createInstance()
	{
		...
		appInfo.pApplicationName = "Henlo Triangle";
		...
		//TODO: check if required extensions are supported
	...
	//TODO: check if variable extensions are supported (supported likely variable as well)
	bool checkIfExtensionsAreSupported(const char** extensionNames, const std::vector<VkExtensionProperties> supported)
	{
	}
...
#pragma region Textures
	...
	void createTextureImage(Texture& texture, std::string filepath, VkFormat format)
	{
	...
	{
		tex.imageView = createImageView(tex.image, tex.format, VK_IMAGE_ASPECT_COLOR_BIT);
	}
	...
	void loadTextures()
	{
		createTextureImage(baseColorTex, BASECOLOR_TEXTURE_PATH, VK_FORMAT_R8G8B8A8_SRGB);
		createImageView(baseColorTex);

		createTextureImage(emissiveTex, EMISSIVE_TEXTURE_PATH, VK_FORMAT_R8G8B8A8_SRGB);
		createImageView(emissiveTex);

		createTextureImage(heightTex, HEIGHT_TEXTURE_PATH, VK_FORMAT_R8G8B8A8_SRGB);
		createImageView(heightTex);

		createTextureImage(metallicTex, METALLIC_TEXTURE_PATH, VK_FORMAT_R8G8B8A8_SRGB);
		createImageView(metallicTex);

		createTextureImage(normalTex, NORMAL_TEXTURE_PATH, VK_FORMAT_R8G8B8A8_SRGB);
		createImageView(normalTex);

		createTextureImage(roughnessTex, ROUGHNESS_TEXTURE_PATH, VK_FORMAT_R8G8B8A8_SRGB);
